...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <head>
	<title>.:: APARAT (Aplikasi Surat Menyurat) ::.</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta charset="utf-8">
    <link rel="icon" type="image/png" href="<?php echo base_url(); ?>aset/logo-man.png">
	<style type="text/css">
	@font-face {
	  font-family: 'Cabin';
	  font-style: normal;
  ...
  <body style="">
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
         <span class="navbar-brand"><strong style="font-family: verdana;">APARAT</strong></span>
    ...
    <div class="container">
	  ...
	  <div class="span12 well well-sm">
		<h4 style="font-weight: bold">APARAT (Aplikasi Surat Menyurat)</h4>
		<h6>&copy;  2017. MAN 1 Kota Malang | Waktu Eksekusi : {elapsed_time}, Penggunaan Memori : {memory_usage}</h6>
	  </div>
